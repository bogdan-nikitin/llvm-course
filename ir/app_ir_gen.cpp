...
int main() {
  ...
  Value *val1 =
      builder.CreateAlloca(ArrayType::get(builder.getInt8Ty(), 262144));
  ...
  Value *val12 =
      builder.CreateTrunc(val11, builder.getInt8Ty(), "", false, true);
  ...
  Value *val14 =
      builder.CreateInBoundsGEP(ArrayType::get(builder.getInt8Ty(), 262144),
                                val1, {builder.getInt64(0), val13});
  ...
  Value *val26 =
      builder.CreateTrunc(val23, builder.getInt32Ty(), "", true, true);
  //   br label %33
  ...
  Value *val29 = builder.CreateSelect(val28, builder.getInt64(131072),
                                      builder.getInt64(0));
  //   br label %43
  ...
  Value *val39 = builder.CreateSelect(val38, builder.getInt32(-16777216),
                                      builder.getInt32(-1));
  //   %40 = trunc nuw nsw i64 %34 to i32
  Value *val40 =
      builder.CreateTrunc(val34, builder.getInt32Ty(), "", true, true);
  //   tail call void @simPutPixel(i32 noundef %40, i32 noundef %26, i32 noundef
  //   %39) #3
  ...
  Value *val109 =
      builder.CreateInBoundsGEP(ArrayType::get(builder.getInt8Ty(), 262144),
                                val1, {builder.getInt64(0), val108});
  ...
  Value *val118 =
      builder.CreateInBoundsGEP(ArrayType::get(builder.getInt8Ty(), 262144),
                                val1, {builder.getInt64(0), val117});
  ...
  Value *val126 =
      builder.CreateInBoundsGEP(ArrayType::get(builder.getInt8Ty(), 262144),
                                val1, {builder.getInt64(0), val125});
  ...
  Value *val135 =
      builder.CreateInBoundsGEP(ArrayType::get(builder.getInt8Ty(), 262144),
                                val1, {builder.getInt64(0), val134});
  ...
  Value *val145 =
      builder.CreateInBoundsGEP(ArrayType::get(builder.getInt8Ty(), 262144),
                                val1, {builder.getInt64(0), val144});
  ...
  Value *val151 =
      builder.CreateInBoundsGEP(ArrayType::get(builder.getInt8Ty(), 262144),
                                val1, {builder.getInt64(0), val149});
