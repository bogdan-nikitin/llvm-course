...
#define READ_3REGS_IMM                                                         \
  { READ_REG(A1) READ_REG(A2) READ_REG(A3) READ_IMM(A4) }
#define READ_4REGS                                                             \
...
#define READ_LABEL_2REGS                                                       \
  { READ_LABEL READ_REG(A2) READ_REG(A3) }
...
#define WRITE_LABEL_2REGS                                                      \
  { WRITE_LABEL WRITE_REG(A2) WRITE_REG(A3) }
...
_ISA(
    ...
    { STORE_REG(builder.CreateAnd(builder.CreateAdd(LOAD_REG(I.A2), LOAD_REG(I.A3)), GEN_IMM(I.A4))); })
...
_ISA(
    ...
    {
      STORE_REG(builder.CreateOr(LOAD_REG(I.A1), builder.CreateOr(LOAD_REG(I.A2), LOAD_REG(I.A3))));
    })
...
//    BR update (1LABEL)
_ISA(
    0x14, BR, SKIP_1ARG, READ_LABEL, WRITE_LABEL,
    {
      C->NextPC = A1;
    },
    {
